...
const ValidationSection = () => {
    ...
    return (
        <section id="validation" style={{ padding: "96px 0", background: "white" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
                <div style={{ marginBottom: 48 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
                        ...
                        <div>
                            <div style={{ padding: "16px 20px", background: "#fdecea", border: "1px solid rgba(192,57,43,0.3)", borderLeft: "4px solid var(--critical)", borderRadius: "0 8px 8px 0", marginBottom: 16 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 12, marginTop: 32 }}>
                    {[
                        ...
                        <div key={s.step} style={{ background: "var(--gray-50)", border: `1px solid ${s.color}44`, borderTop: `3px solid ${s.color}`, borderRadius: 8, padding: 16, textAlign: "center" }}>
                            ...
                            <span style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: s.color, background: `${s.color}11`, padding: "2px 8px", border: `1px solid ${s.color}33`, borderRadius: 2, fontWeight: 600, letterSpacing: "0.06em" }}>{s.status}</span>
                        </div>
                    ))}
                </div>
            </div>
