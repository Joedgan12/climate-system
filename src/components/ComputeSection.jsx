const ComputeSection = () => {
    ...
    return (
        <section id="compute" style={{ padding: "96px 0", background: "var(--gray-50)" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, marginBottom: 56 }}>
                    <div>
                        ...
                        <h2 style={{ fontFamily: "var(--font-serif)", fontSize: 40, fontWeight: 400, lineHeight: 1.2, marginBottom: 20 }}>
                            24,576-core hybrid<br />compute cluster
                        </h2>
