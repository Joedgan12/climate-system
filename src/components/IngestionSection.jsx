...
const IngestionSection = () => {
    ...
    return (
        <section id="ingestion" style={{ padding: "96px 0", background: "var(--white)" }}>
            <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 24px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start", marginBottom: 64 }}>
                    <div>
                        ...
                        <h2 style={{ fontFamily: "var(--font-serif)", fontSize: 40, fontWeight: 400, lineHeight: 1.2, color: "var(--gray-900)", marginBottom: 20 }}>
                            Planetary-scale observation<br />pipeline
                        </h2>
